...
export const PricingCta: React.FC<PricingCtaProps> = ({
  ...
  <section className="bg-theme-sand w-full">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
      <div className="bg-theme-sage/10 border border-theme-sage/25 rounded-3xl px-8 sm:px-16 py-14 flex flex-col sm:flex-row items-center justify-between gap-8">
