...
export const LanguagesHero: React.FC<LanguagesHeroProps> = ({
  eyebrow,
  headingMain,
  headingAccent,
  subtext,
        ...
        {stats && stats.length > 0 && (
          <div className="flex flex-wrap justify-center gap-3 mt-2">
            {stats.map((s, i) => (
              <div
                key={i}
                className="flex items-center gap-2 bg-white border border-theme-border rounded-full px-5 py-2"
              >
                <span className="font-serif font-bold text-theme-sage text-lg leading-none">
                  {s.value}
                </span>
